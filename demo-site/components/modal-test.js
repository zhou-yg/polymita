...
import { ACTIVE as ACTIVE2, FOCUS, h as h4, HOVER as HOVER2, useLogic as useLogic2 } from "@polymita/renderer";
...
var layout4 = (props) => {
  ...
  return /* @__PURE__ */ h5("modalTest", null, /* @__PURE__ */ h5(Button2, { onClick: () => {
    setVisible(true);
  } }, "\u663E\u793A ", name), /* @__PURE__ */ h5("input", { value: name }), /* @__PURE__ */ h5(Input, { value: name, onInput: (v) => setName(v) }), visible ? /* @__PURE__ */ h5(Modal, { title: "\u6807\u9898", onClose: () => setVisible(false) }, /* @__PURE__ */ h5("p", null, "name:", /* @__PURE__ */ h5(Input, { key: "name", value: name, onInput: (v) => setName(v) }))) : "");
};
