...
import { CloseSquareFilled,CloseSquareOutlined,CloseSquareTwoTone } from '@ant-design/icons-svg'
import { renderIconDefinitionToSVGElement } from '@ant-design/icons-svg/es/helpers';
import { h, createComponent } from 'tarat-renderer';

const CloseSquareFilledSVGString = renderIconDefinitionToSVGElement(CloseSquareFilled, {
  extraSVGAttrs: { width: '1em', height: '1em', fill: 'currentColor' }
});
const CloseSquareOutlinedSVGString = renderIconDefinitionToSVGElement(CloseSquareOutlined, {
  extraSVGAttrs: { width: '1em', height: '1em', fill: 'currentColor' }
});
const CloseSquareTwoToneSVGString = renderIconDefinitionToSVGElement(CloseSquareTwoTone, {
  extraSVGAttrs: { width: '1em', height: '1em', fill: 'currentColor' }
});
